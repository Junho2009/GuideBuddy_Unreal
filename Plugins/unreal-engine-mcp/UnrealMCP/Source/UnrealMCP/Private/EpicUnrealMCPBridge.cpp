    ...
    AsyncTask(ENamedThreads::GameThread, [this, CommandType, Params, Promise = MoveTemp(Promise)]() mutable
    {
        ...
        try
        {
            ...
            // Editor Commands (including actor manipulation)
                     ...
                     CommandType == TEXT("new_level_from_template") ||
                     ...
                     CommandType == TEXT("rename_function"))
            {
                ResultJson = BlueprintGraphCommands->HandleCommand(CommandType, Params);
                     ...
                     CommandType == TEXT("ensure_input_mapping_context") ||
                     CommandType == TEXT("add_mapping_to_imc"))
            {
                ResultJson = InputCommands->HandleCommand(CommandType, Params);
            }
            else if (CommandType == TEXT("add_widget_to_user_widget") ||
                     CommandType == TEXT("create_widget_from_layout") ||
                     CommandType == TEXT("edit_widget_property") ||
                     CommandType == TEXT("get_batch_widget_properties"))
            {
